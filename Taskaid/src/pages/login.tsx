...
export default function LoginPage() {
    ...
    return (
        <div className="grid grid-cols-1 md:grid-cols-2 h-screen w-screen">
            ...
            <div className="hidden md:flex flex-col items-center justify-center bg-gradient-to-br from-blue-600 to-indigo-700 text-white p-12">
            ...
            <div className="flex items-center justify-center bg-gray-400 ">
                ...
                <form onSubmit={handleLogin} className="p-8 rounded-2xl w-96">
